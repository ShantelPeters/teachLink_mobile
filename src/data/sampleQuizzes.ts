    ...
    questions: [
      {
        ...
        correctAnswer: 0,
        explanation: 'React Native allows you to write code once and deploy to both iOS and Android platforms.',
        points: 20,
      },
      {
        id: 'q1-2',
        ...
        multiple: true,
        correctAnswer: [0, 1, 2],
        explanation: 'React Native provides fast refresh, has a large community, and uses native components. You don\'t need to learn Swift or Kotlin.',
        points: 20,
      },
      {
        id: 'q1-3',
        ...
        options: ['True', 'False'],
        correctAnswer: 0,
        explanation: 'Yes, React Native is built on JavaScript and React, allowing web developers to easily transition to mobile development.',
        points: 20,
      },
      {
        id: 'q1-4',
      ...
      },
      {
        ...
        multiple: true,
        correctAnswer: [0, 1, 2],
        explanation: 'You need Node.js, platform-specific tools (Xcode/Android Studio), and Expo Go for testing. Python is not required.',
        points: 20,
      },
    ],
  },
    ...
    questions: [
      {
        ...
        multiple: true,
        correctAnswer: [0, 1, 2],
        explanation: 'View, Text, and TouchableOpacity are React Native primitives. "div" is a web HTML element, not used in React Native.',
        points: 20,
      },
      {
        id: 'q2-2',
        ...
        options: ['True', 'False'],
        correctAnswer: 0,
        explanation: 'Yes, JSX syntax is similar to HTML, but React Native uses primitives like View instead of div, and Text instead of p.',
        points: 20,
      },
      {
        id: 'q2-3',
        ...
        correctAnswer: 0,
        explanation: 'TeachLink uses NativeWind, which brings Tailwind CSS classes to React Native through className props.',
        points: 20,
      },
      {
        id: 'q2-4',
        type: 'multiple-choice',
        question: 'Which navigator types are available in React Navigation? (Select all that apply)',
        options: [
          'Stack Navigator',
          'Tab Navigator',
          'Drawer Navigator',
        ...
        multiple: true,
        correctAnswer: [0, 1, 2],
        explanation: 'React Navigation provides Stack, Tab, and Drawer navigators. There is no Grid Navigator.',
        points: 20,
      },
      {
        id: 'q2-5',
        ...
        correctAnswer: 0,
        explanation: 'React Native supports useState, useReducer, and Zustand. The course mentions using Zustand for app-wide state and hooks for component-specific state.',
        points: 20,
      },
    ],
  },
