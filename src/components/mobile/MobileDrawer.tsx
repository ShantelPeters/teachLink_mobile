...
export const MobileDrawer = (props: DrawerContentComponentProps) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#fff' }}>
            <View className="p-4 border-b border-gray-100 bg-gray-50 pt-12" style={{ paddingTop: top + 16 }}>
            ...
            <DrawerContentScrollView {...props} contentContainerStyle={{ paddingTop: 0 }}>
                ...
                <View className="mt-4 px-4 border-t border-gray-100 pt-4">
                    <TouchableOpacity className="flex-row items-center gap-3 py-3" onPress={() => { }}>
            ...
            <View className="p-4 border-t border-gray-200 bg-gray-50" style={{ paddingBottom: bottom + 16 }}>
